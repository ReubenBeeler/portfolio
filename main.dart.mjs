...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1296: () => globalThis.removeSplashFromWeb(),
      _1297: Date.now,
      ...
      _1335: Object.is,
      _1336: o => o instanceof Array,
      _1341: a => a.pop(),
      _1342: (a, i) => a.splice(i, 1),
      _1343: (a, s) => a.join(s),
      _1344: (a, s, e) => a.slice(s, e),
      _1347: a => a.length,
      _1349: (a, i) => a[i],
      _1350: (a, i, v) => a[i] = v,
      _1352: o => {
      ...
      _1353: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1355: o => o instanceof Uint8Array,
      _1356: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1357: o => o instanceof Int8Array,
      _1358: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1359: o => o instanceof Uint8ClampedArray,
      _1360: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1361: o => o instanceof Uint16Array,
      _1362: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1363: o => o instanceof Int16Array,
      _1364: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1365: o => o instanceof Uint32Array,
      _1366: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1367: o => o instanceof Int32Array,
      _1368: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1370: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1371: o => o instanceof Float32Array,
      _1372: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1373: o => o instanceof Float64Array,
      ...
      _1427: () => new AbortController(),
      _1428: x0 => x0.abort(),
      _1429: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1430: (x0,x1) => globalThis.fetch(x0,x1),
      _1431: (x0,x1) => x0.get(x1),
      _1432: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1432(f,arguments.length,x0,x1,x2) }),
      _1433: (x0,x1) => x0.forEach(x1),
      ...
      _8561: x0 => x0.url,
      _8563: x0 => x0.status,
      _8565: x0 => x0.statusText,
      _8566: x0 => x0.headers,
      _8567: x0 => x0.body,
      _10963: (x0,x1) => { x0.cursor = x1 },
      _12195: x0 => x0.name,
